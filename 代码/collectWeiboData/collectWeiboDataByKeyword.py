...
class CollectData():
    ...
    ##构建URL
    def getURL(self):
        return self.begin_url_per + "%E6%8B%9B%E5%95%86%E9%93%B6%E8%A1%8C" + "&typeall=1&suball=1&timescope=custom:" + self.timescope + "&page="
        # print self.begin_url_per+self.getKeyWord()+"&typeall=1&suball=1&timescope=custom:"+self.timescope+"&page="
